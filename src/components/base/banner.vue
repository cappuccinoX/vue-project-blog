...
<!--        <li>-->
<!--          <img :src="illustrationData[illustrationData.length-1].image">-->
<!--        </li>-->
<!--        <li v-for="(item,index) in illustrationData" v-bind:key="index">-->
<!--          <img src="item.image" alt="">-->
<!--        </li>-->
<!--        <li>-->
<!--          <img :src="illustrationData[0].image" alt="">-->
<!--        </li>-->
<!--      </ul>-->
<!--      <ul class="direction">-->
...
<!--      </ul>-->
<!--      <ul class="dots">-->
<!--        <li v-for="(item, index) in illustrationData" v-bind:key="index" :class="{dotted: index === (currentIndex-1)}"></li>-->
<!--      </ul>-->
<!--    </div>-->
<!--  </div>-->
<!--</template>-->
